      ...
      <div className="container">
          ...
          <ul>
              <li>Р – вероятность НБ у женщин с ожирением (%)</li>
                  ...
                  <li>Х<sub>КУР</sub> – наличие курения   (0 – некурящие, 1 - курящие)</li>
                  <li>X<sub>AGT</sub> – концентрация в сыворотке крови ангиотензиногена (0 - более 0,608, 1 – менее 0,608)</li>
                  <li>Х<sub>TTR</sub> –  концентрация в сыворотке крови транстиретина (0 - более 0,074, 1 – менее 0,074)</li>
                  <li>Х<sub>С-пептид</sub> – концентрация в сыворотке крови С-пептида (0 - менее 5,2 нг/мл, 1 – более 5,2 нг/мл)</li>
          </ul>
